...
class FinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fine" do
    assert_difference("Fine.count") do
      post fines_url, params: { fine: { amount: @fine.amount, motive: @fine.motive, user_id: @fine.user_id } }
    end
  ...
  test "should update fine" do
    patch fine_url(@fine), params: { fine: { amount: @fine.amount, motive: @fine.motive, user_id: @fine.user_id } }
