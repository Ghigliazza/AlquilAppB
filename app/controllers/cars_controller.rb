class CarsController < ApplicationController
  ...
  def car_params
    params.require(:car).permit(:model, :brand, :license, :color, :img_url, :doors, :seats, :state, :engine, :fuel, :position_id, :used, :turn_on, :coords_x, :coords_y, :car_photo, :transmission)
  end
